package com.proccaptald.proffesionalestic.game.actors.checkbox
...
import com.proccaptald.proffesionalestic.game.actors.checkbox.ACheckBox.Static.Type.*
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.SOUND -> Static.ACheckBoxStyle(
            default = screen.game.all.sound_def,
            checked = screen.game.all.sound_check,
        )
    }
