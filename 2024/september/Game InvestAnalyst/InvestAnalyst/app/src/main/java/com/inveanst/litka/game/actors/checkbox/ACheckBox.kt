package com.inveanst.litka.game.actors.checkbox
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.DEFAULT -> Static.ACheckBoxStyle(
            default = screen.game.all.box_def,
            checked = screen.game.all.box_check,
        )
    }
