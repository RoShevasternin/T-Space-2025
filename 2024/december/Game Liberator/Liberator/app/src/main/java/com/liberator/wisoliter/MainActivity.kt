package com.liberator.wisoliter
...
import com.liberator.wisoliter.databinding.ActivityMainBinding
import com.liberator.wisoliter.game.utils.runGDX
import com.liberator.wisoliter.util.OneTime
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    private inner class WebClient : WebViewClient() {
        override fun shouldOverrideUrlLoading(
            ...
            if (request?.url.toString().contains("vizvolit/nenaviz")) {
                log("contains")
                hideWebView()
                blockRedirect()
                return true
