package com.liberator.wisoliter.game.actors.button
...
import com.liberator.wisoliter.game.utils.TextureEmpty
import com.liberator.wisoliter.game.utils.actor.animHide
import com.liberator.wisoliter.game.utils.actor.animShow
...
open class AButton(
    ...
    private fun getStyleByType(type: Type) = when(type) {
        ...
        Type.Magaz -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.magaz_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.magaz_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.magaz_press),
        )
        Type.Army -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.army_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.army_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.army_press),
        )
        Type.Conty -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.continue_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.continue_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.continue_press),
        )
        Type.STO -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.sto_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.sto_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.sto_press),
        )
        Type.Create -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.create_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.create_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.create_press),
        )
        Type.Atak -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.atak_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.atak_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.atak_press),
        )
    }
    ...
    enum class Type {
        None, X, Magaz, Army, Conty, STO, Create, Atak
    }
