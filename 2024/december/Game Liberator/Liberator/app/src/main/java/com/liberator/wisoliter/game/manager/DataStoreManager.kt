...
object DataStoreManager: AbstractDataStore() {
    ...
    object DataItem: DataStoreElement<String>() {
        override val key = stringPreferencesKey("data_item")
    }
    object CountryUron: DataStoreElement<String>() {
        override val key = stringPreferencesKey("country_uron")
    }
