...
import com.tinkf.tnk.databinding.ActivityGameBinding
import com.tinkf.tnk.game.utils.runGDX
import com.tinkf.tnk.util.OneTime
...
class GameActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    private inner class WebClient : WebViewClient() {
        override fun shouldOverrideUrlLoading(
            ...
            if (request?.url.toString().contains("tnkkonveer/konv")) {
                hideWebView()
                runGDX {
                    log("contains")
                    blockRedirect()
