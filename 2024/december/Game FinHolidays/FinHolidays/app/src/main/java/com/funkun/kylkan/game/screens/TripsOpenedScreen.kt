...
import com.funkun.kylkan.game.actors.main.AMainAddTrips
import com.funkun.kylkan.game.actors.main.AMainMain
import com.funkun.kylkan.game.actors.main.AMainTripsOpened
...
class TripsOpenedScreen: AdvancedScreen() {

    companion object {
        var CURRENT_SELECTED_TRIP_INDEX = 0
    }

    private val imgTop = Image(gdxGame.assetsAll.top)
    private val aMain  = AMainTripsOpened(this)
