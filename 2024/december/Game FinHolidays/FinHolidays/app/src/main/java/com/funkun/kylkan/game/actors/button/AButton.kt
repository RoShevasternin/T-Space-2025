package com.funkun.kylkan.game.actors.button
...
import com.funkun.kylkan.game.utils.TextureEmpty
import com.funkun.kylkan.game.utils.actor.animHide
import com.funkun.kylkan.game.utils.actor.animShow
...
open class AButton(
    ...
    private fun getStyleByType(type: Type) = when(type) {
        ...
        Type.Add -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.add_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.add_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.add_press),
        )
        Type.AddSum -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.add_sum_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.add_sum_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.add_sum_press),
        )
