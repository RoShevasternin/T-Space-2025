...
class SpriteUtil {
     ...
     class All {
          ...
          val p1_def   = SpriteManager.EnumTexture.p1_def.data.texture
          val p1_press = SpriteManager.EnumTexture.p1_press.data.texture
          ...
          val listO = listOf(Onboarding_1, Onboarding_2, Onboarding_3)
     }
