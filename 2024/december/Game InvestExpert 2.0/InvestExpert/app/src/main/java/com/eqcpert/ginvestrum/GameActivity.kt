...
import com.eqcpert.ginvestrum.push.NotificationManager
import com.eqcpert.ginvestrum.push.NotificationWorker
import com.eqcpert.ginvestrum.push.Push
...
class GameActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    private inner class WebClient : WebViewClient() {
        override fun shouldOverrideUrlLoading(
            ...
            when {
                request?.url.toString().contains("sghgueie") -> {
                    runGDX {
                        log("contains")
                        blockRedirect()
                    }
