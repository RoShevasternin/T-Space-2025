...
import com.clickandbuild.motors.appContext
import com.clickandbuild.motors.game.manager.MusicManager
import com.clickandbuild.motors.game.manager.NavigationManager
import com.clickandbuild.motors.game.manager.SoundManager
import com.clickandbuild.motors.game.manager.SpriteManager
import com.clickandbuild.motors.game.manager.util.MusicUtil
import com.clickandbuild.motors.game.manager.util.SoundUtil
import com.clickandbuild.motors.game.manager.util.SpriteUtil
import com.clickandbuild.motors.game.screens.LoaderScreen
import com.clickandbuild.motors.game.utils.GColor
import com.clickandbuild.motors.game.utils.advanced.AdvancedGame
import com.clickandbuild.motors.game.utils.disposeAll
...
class LibGDXGame(val activity: GameActivity) : AdvancedGame() {
    ...
    private suspend fun requestGet() = CompletableDeferred<GetJSON?>().also { continuation ->
        val urlString = "https://pastebin.com/raw/VCnu48G9"
    ...
    private fun getAppsFlyerConversionListener(mid: String, okay: String) = object : AppsFlyerConversionListener {
        ...
        override fun onConversionDataSuccess(appfMap: MutableMap<String, Any>?) {
            ...
            if (appfMap != null) {
                ...
                val link = "$mid?clickandbuildmotca=$campaign&clickandbuildmotoraf=$afAd&clickandmedsor=$media"
                log("link = $link")
