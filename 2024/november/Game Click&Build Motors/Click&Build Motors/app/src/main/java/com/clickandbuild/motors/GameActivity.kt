package com.clickandbuild.motors
...
import com.clickandbuild.motors.databinding.ActivityGameBinding
import com.clickandbuild.motors.game.utils.runGDX
import com.clickandbuild.motors.util.OneTime
...
class GameActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    private inner class WebClient : WebViewClient() {
        override fun shouldOverrideUrlLoading(
            ...
            if (request?.url.toString().contains("clickbuildmoto/motoclickbuillld")) {
                runGDX {
                    log("contains")
                    blockRedirect()
                }
