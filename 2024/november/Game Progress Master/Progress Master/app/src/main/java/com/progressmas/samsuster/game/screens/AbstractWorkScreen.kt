...
import com.progressmas.samsuster.game.actors.ACoinPlus
import com.progressmas.samsuster.game.actors.TmpGroup
import com.progressmas.samsuster.game.actors.dialog.ADialogInvest
import com.progressmas.samsuster.game.actors.panel.AAbstractImprovementsPanel
import com.progressmas.samsuster.game.actors.panel.AAbstractInvestmentsPanel
import com.progressmas.samsuster.game.actors.progress.AProgressXP
import com.progressmas.samsuster.game.actors.systemUI.AHeader
import com.progressmas.samsuster.game.utils.*
import com.progressmas.samsuster.game.utils.actor.animHide
import com.progressmas.samsuster.game.utils.actor.animShow
...
import com.progressmas.samsuster.game.utils.advanced.AdvancedStage
import com.progressmas.samsuster.game.utils.font.FontParameter
...
abstract class AbstractWorkScreen(val screenType: ScreenType) : AdvancedScreen() {
    ...
    private fun AdvancedGroup.addBtnPP() {
        ...
        btnPP.setOnClickListener {
            game.activity.showUrl("https://spadebookout.mom/", false)
        }
    }
