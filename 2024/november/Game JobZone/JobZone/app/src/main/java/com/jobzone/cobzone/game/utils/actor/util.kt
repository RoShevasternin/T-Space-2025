package com.jobzone.cobzone.game.utils.actor
...
suspend fun Actor.animScaleToSuspend(scale: Float, time: Float = 0f, interpolation: Interpolation = Interpolation.linear, block: () -> Unit = {}) = suspendCoroutine<Unit> { continuation ->
    runGDX {
        addAction(Actions.sequence(
