...
import com.jobzone.cobzone.game.actors.main.AMainNotActive
...
class NotActiveScreen(override val game: GDXGame): AdvancedScreen() {

    private val aPanelTop = APanelTop(this)
    private val aMain     = AMainNotActive(this)
    ...
    private fun AdvancedStage.addBottom() {
        ...
        if (bottomPadding > 0) {
            val imgBottom = Image(drawerUtil.getTexture(GameColor.bottom2))
            addActor(imgBottom)
