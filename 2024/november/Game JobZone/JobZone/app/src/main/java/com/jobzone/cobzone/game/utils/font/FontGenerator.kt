package com.jobzone.cobzone.game.utils.font
...
class FontGenerator(fontPath: FontPath): FreeTypeFontGenerator(Gdx.files.internal(fontPath.path)) {
    ...
    companion object {
        enum class FontPath(val path: String) {
            Gilroy_Medium("font/Gilroy-Medium.ttf"),
            Gilroy_Regular("font/Gilroy-Regular.ttf"),
            Gilroy_Semibold("font/Gilroy-Semibold.ttf"),
        }
    }
