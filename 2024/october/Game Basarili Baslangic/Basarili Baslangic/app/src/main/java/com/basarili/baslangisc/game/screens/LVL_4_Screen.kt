...
class LVL_4_Screen(override val game: LibGDXGame) : AbstractLVLScreen() {

    override val valueClick: Int = 4
    override val valueLVL  : Int = 4
    ...
    private fun AdvancedStage.addImgBuildings() {
        val list = listOf(imgBuilding1, imgBuilding2, item3, item4)
        addActors(list)
