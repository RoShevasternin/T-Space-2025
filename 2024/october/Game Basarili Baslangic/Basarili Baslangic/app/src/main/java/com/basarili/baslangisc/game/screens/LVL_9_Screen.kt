...
class LVL_9_Screen(override val game: LibGDXGame) : AbstractLVLScreen() {

    override val valueClick: Int = 9
    override val valueLVL  : Int = 9
    ...
    private fun AdvancedStage.addImgBuildings() {
        val list = listOf(imgBuilding1, imgBuilding2, item3, item4, item5, item6, item7, item8, item9)
        addActors(list)
