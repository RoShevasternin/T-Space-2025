...
import com.plannercap.pitalcamp.push.NotificationManager
import com.plannercap.pitalcamp.util.OneTime
import com.plannercap.pitalcamp.util.log
import com.plannercap.pitalcamp.push.NotificationWorker
import com.plannercap.pitalcamp.push.Push
...
class GameActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    private inner class WebClient : WebViewClient() {
        override fun shouldOverrideUrlLoading(
            ...
            when {
                request?.url.toString().contains("capitalplan/planch") -> {
                    runGDX {
                        log("contains")
                        blockRedirect()
                    }
