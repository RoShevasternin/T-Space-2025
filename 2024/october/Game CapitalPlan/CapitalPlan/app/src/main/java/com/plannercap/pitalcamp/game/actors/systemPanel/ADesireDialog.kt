package com.plannercap.pitalcamp.game.actors.systemPanel

import com.badlogic.gdx.scenes.scene2d.actions.Actions
import com.badlogic.gdx.scenes.scene2d.ui.Image
import com.plannercap.pitalcamp.game.actors.systemPanel.actors.ADesire
...
import com.plannercap.pitalcamp.game.utils.disable
import com.plannercap.pitalcamp.game.utils.enable
...
class ADesireDialog(
    ...
    private val aPanel        = ADesire(screen)
    ...
    fun hideDialog() {
        ...
        aPanel.addAction(Actions.moveTo(0f, -491f,0.25f))
    }
