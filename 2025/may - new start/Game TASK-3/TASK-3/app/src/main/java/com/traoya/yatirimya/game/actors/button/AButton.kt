...
import com.traoya.yatirimya.game.utils.TextureEmpty
...
open class AButton(
    ...
    private fun getStyleByType(type: Type) = when(type) {
        ...
        Type.RD -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.rd_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.rd_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.rd_press),
        )
    }
