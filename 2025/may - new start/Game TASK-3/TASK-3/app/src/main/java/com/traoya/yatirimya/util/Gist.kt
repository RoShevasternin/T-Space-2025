...
object Gist {
    ...
    private const val URL_STRING = "https://gist.githubusercontent.com/VladLibGDX/8ef076a35910f917ed685fc66567bfb0/raw/com.traoya.yatirimya"
    ...
    suspend fun getDataJson(): DataJSON? = withContext(Dispatchers.IO) {
        try {
            ...
            if (connection.responseCode == HttpURLConnection.HTTP_OK) {
                ...
                DataJSON(
                    linkD  = json.optString("link22", ""),
                    keyAF = json.optString("key22", "")
                )
            } else {
