package com.cryonetpoint.ecsporush.game.actors.button
...
import com.cryonetpoint.ecsporush.game.utils.TextureEmpty
...
import com.cryonetpoint.ecsporush.game.utils.region
...
open class AButton(
    ...
    private fun getStyleByType(type: Type) = when(type) {
        ...
        Type.Answer -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.answer_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.answer_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.answer_press),
        )
        ...
        Type.Random -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.random_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.random_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.random_press),
        )
        Type.Q1 -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.qwiz_1_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.qwiz_1_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.qwiz_1_press),
        )
        Type.Q2 -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.qwiz_2_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.qwiz_2_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.qwiz_2_press),
        )
        Type.Q3 -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.qwiz_3_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.qwiz_3_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.qwiz_3_press),
        )
        Type.All -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.all_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.all_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.all_press),
        )
    }
