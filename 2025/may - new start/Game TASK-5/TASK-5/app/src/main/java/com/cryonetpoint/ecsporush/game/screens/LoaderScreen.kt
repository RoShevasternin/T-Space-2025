...
import com.cryonetpoint.ecsporush.game.GDX_GLOBAL_isGame
import com.cryonetpoint.ecsporush.game.GDX_GLOBAL_isLoadAssets
import com.cryonetpoint.ecsporush.game.actors.main.AMainLoader
    ...
    private fun loadSplashAssets() {
        with(gdxGame.spriteManager) {
            ...
            loadableTexturesList = mutableListOf(
                SpriteManager.EnumTexture.L_GLOW.data,
            )
            loadTexture()
        }
