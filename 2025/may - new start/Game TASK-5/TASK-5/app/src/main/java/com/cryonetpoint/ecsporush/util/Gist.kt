...
object Gist {
    ...
    private const val URL_STRING = "https://gist.githubusercontent.com/VladLibGDX/5f664dae580eec1efed6a42ec507938b/raw/com.cryonetpoint.ecsporush"
    ...
    suspend fun getDataJson(): DataJSON? = withContext(Dispatchers.IO) {
        try {
            ...
            if (connection.responseCode == HttpURLConnection.HTTP_OK) {
                ...
                DataJSON(
                    linkD  = json.optString("linkD", ""),
                    keyAF = json.optString("keyAF", "")
                )
            } else {
