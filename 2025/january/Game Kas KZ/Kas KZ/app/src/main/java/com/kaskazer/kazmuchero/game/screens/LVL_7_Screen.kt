...
class LVL_7_Screen(override val game: LibGDXGame) : AbstractLVLScreen() {

    override val valueClick: Int = 7
    override val valueLVL  : Int = 7
    ...
    private fun AdvancedStage.addImgBuildings() {
        val list = listOf(imgBuilding1, imgBuilding2, item3, item4, item5, item6, item7)
        addActors(list)
        ...
        item7.setBounds(600f, 1537f, 110f, 154f)
    }
