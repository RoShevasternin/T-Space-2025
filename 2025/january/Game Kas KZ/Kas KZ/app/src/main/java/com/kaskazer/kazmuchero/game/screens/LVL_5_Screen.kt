...
class LVL_5_Screen(override val game: LibGDXGame) : AbstractLVLScreen() {

    override val valueClick: Int = 5
    override val valueLVL  : Int = 5
    ...
    private fun AdvancedStage.addImgBuildings() {
        val list = listOf(imgBuilding1, imgBuilding2, item3, item4, item5)
        addActors(list)
        ...
        item5.setBounds(77f, 1595f, 167f, 203f)
    }
