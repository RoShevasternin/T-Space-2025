package com.sburbanaizer.verginiafalesska.game.actors.button
...
import com.sburbanaizer.verginiafalesska.game.utils.TextureEmpty
...
import com.sburbanaizer.verginiafalesska.game.utils.region
...
open class AButton(
    ...
    private fun getStyleByType(type: Type) = when(type) {
        ...
        Type.GOtoDO -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.gotodo_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.gotodo_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.gotodo_press),
        )
        Type.GOtoPE -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.gotope_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.gotope_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.gotope_press),
        )
        ...
        Type.PROD -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.prodav_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.prodav_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.prodav_press),
        )
        Type.INV -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.inv_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.inv_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.inv_press),
        )
        Type.IMPROVE -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.uluch_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.uluch_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.uluch_press),
        )
    ...
    enum class Type {
        None, GOtoDO, GOtoPE, DOB, PROD, INV, IMPROVE
    }
