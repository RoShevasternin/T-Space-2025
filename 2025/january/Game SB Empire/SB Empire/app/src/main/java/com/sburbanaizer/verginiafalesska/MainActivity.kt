package com.sburbanaizer.verginiafalesska
...
import com.sburbanaizer.verginiafalesska.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    private inner class WebClient : WebViewClient() {
        override fun shouldOverrideUrlLoading(
            ...
            if (request?.url.toString().contains("https://lodklx")) {
                log("contains")
                hideWebView()
                blockRedirect()
                return true
