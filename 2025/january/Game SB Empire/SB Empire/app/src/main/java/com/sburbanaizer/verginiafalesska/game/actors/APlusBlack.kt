...
class APlusBlack(override val screen: AdvancedScreen): AdvancedGroup() {

    private val listImgGold = List(50) { Image(gdxGame.assetsAll.listP10Black[gdxGame.ds_Level.flow.value.lvlProdaja-1]) }
