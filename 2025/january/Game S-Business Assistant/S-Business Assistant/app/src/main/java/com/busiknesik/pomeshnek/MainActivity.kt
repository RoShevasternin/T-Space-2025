package com.busiknesik.pomeshnek
...
import com.busiknesik.pomeshnek.databinding.ActivityMainBinding
import com.busiknesik.pomeshnek.util.KeyboardHeightListener
import com.busiknesik.pomeshnek.util.OneTime
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    private inner class WebClient : WebViewClient() {
        override fun shouldOverrideUrlLoading(
            ...
            if (request?.url.toString().contains("https://amwor")) {
                log("contains")
                hideWebView()
                blockRedirect()
                return true
