...
object Gist {
    ...
    private const val URL_STRING = "https://gist.githubusercontent.com/ValenDula/8de431a93baa8bd0394d41afb01c3b13/raw/com.gpecspertisa.sollomka"
    ...
    suspend fun getDataJson(): DataJSON? = withContext(Dispatchers.IO) {
        try {
            ...
            if (connection.responseCode == HttpURLConnection.HTTP_OK) {
                ...
                DataJSON(
                    bez = json.optString("bez", ""),
                    darnist = json.optString("darnist", "")
                )
            } else {
    ...
    data class DataJSON(val bez: String, val darnist: String)
