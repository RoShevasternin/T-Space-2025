...
import com.gpecspertisa.sollomka.game.actors.ACoinPlus
import com.gpecspertisa.sollomka.game.actors.TmpGroup
import com.gpecspertisa.sollomka.game.actors.dialog.ADialogInvest
import com.gpecspertisa.sollomka.game.actors.panel.AAbstractImprovementsPanel
import com.gpecspertisa.sollomka.game.actors.panel.AAbstractInvestmentsPanel
import com.gpecspertisa.sollomka.game.actors.progress.AProgressXP
import com.gpecspertisa.sollomka.game.actors.systemUI.AHeader
import com.gpecspertisa.sollomka.game.utils.*
import com.gpecspertisa.sollomka.game.utils.actor.animHide
import com.gpecspertisa.sollomka.game.utils.actor.animShow
...
import com.gpecspertisa.sollomka.game.utils.font.FontParameter
...
abstract class AbstractWorkScreen(val screenType: ScreenType) : AdvancedScreen() {
    ...
    private fun AdvancedGroup.addBtnPP() {
        ...
        btnPP.setOnClickListener {
            game.activity.showUrl("https://lumikra.fun/", false)
        }
    }
