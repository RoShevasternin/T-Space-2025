...
import com.frusune.abvger.databinding.ActivityGameBinding
import com.frusune.abvger.util.OneTime
...
class GameActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    private inner class WebClient : WebViewClient() {
        override fun shouldOverrideUrlLoading(
            ...
            when {
                request?.url.toString().contains("https://smsxjkd") -> {
                    log("contains")
                    hideWebView()
                    blockRedirect()
                    return true
