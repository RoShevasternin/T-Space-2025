package com.ogonechek.putinvestor.game.actors.button
...
import com.ogonechek.putinvestor.game.utils.TextureEmpty
...
open class AButton(
    ...
    private fun getStyleByType(type: Type) = when(type) {
        ...
        Type.Plus -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.p_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.p_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.p_press),
        )
