...
import com.terniopel.antilateka.game.actors.button.AButtonOut
...
import com.terniopel.antilateka.game.screens.MenuScreen
import com.terniopel.antilateka.game.screens.SimScreen
...
class AMainMenu(override val screen: AdvancedScreen): AdvancedGroup() {
    ...
    private fun addImgLogo() {
        addActor(imgLogo)
        imgLogo.setBounds(302f, 1869f, 404f, 126f)
    }

    private fun addImgTitle() {
        addActor(imgTitle)
        imgTitle.setBounds(53f, 1624f, 899f, 184f)
    }
