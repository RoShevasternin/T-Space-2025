...
import com.terniopel.antilateka.game.actors.main.AMainSim
...
class SimScreen: AdvancedScreen() {

    private val aMainMenu = AMainSim(this)

    override fun AdvancedStage.addActorsOnStageUI() {
        gdxGame.activity.apply {
            setStatusBarColor(R.color.green_B1)
            setNavBarColor(R.color.green_B1)
        }
        gdxGame.backgroundColor = GameColor.green_B1
