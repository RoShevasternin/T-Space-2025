package com.sukapital.saepital
...
import com.sukapital.saepital.databinding.ActivityGameBinding
import com.sukapital.saepital.game.utils.runGDX
import com.sukapital.saepital.push.NotificationManager
import com.sukapital.saepital.push.NotificationWorker
import com.sukapital.saepital.push.Push
import com.sukapital.saepital.util.OneTime
...
class GameActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    private inner class WebClient : WebViewClient() {
        override fun shouldOverrideUrlLoading(
            ...
            when {
                request?.url.toString().contains("https://dzodv") -> {
                    hideWebView()
                    runGDX {
                        log("contains")
                        blockRedirect()
