...
class Factory_3_Screen(override val game: LibGDXGame) : AdvancedScreen() {

    private var TAP_COUNT  = 4
    ...
    private val imgFactory = Image(game.all.t3)
    ...
    override fun AdvancedStage.addActorsOnStageUI() {
        ...
        imgFactory.setBounds(29f,515f,819f,369f)
                ...
                runGDX {
                    if (TAP_COUNT <= 0) {
                        ...
                        root.animHide(TIME_ANIM) {
                            game.navigationManager.navigate(Factory_4_Screen::class.java.name)
                        }
