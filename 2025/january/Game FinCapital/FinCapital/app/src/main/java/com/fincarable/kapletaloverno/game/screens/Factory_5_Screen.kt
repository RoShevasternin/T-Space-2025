...
import com.fincarable.kapletaloverno.game.actors.AOrder
import com.fincarable.kapletaloverno.game.screens.Factory_0_Screen.Companion.BODY_INDEX
import com.fincarable.kapletaloverno.game.screens.Factory_0_Screen.Companion.INTERIOR_INDEX
...
class Factory_5_Screen(override val game: LibGDXGame) : AdvancedScreen() {

    private var TAP_COUNT  = 6
    ...
    private val imgFactory = Image(game.all.listT_5[Factory_4_Screen.BODY_INDEX][Factory_1_Screen.INTERIOR_INDEX])
    ...
    override fun AdvancedStage.addActorsOnStageUI() {
        ...
        imgFactory.setBounds(29f,515f,819f,530f)
                ...
                runGDX {
                    if (TAP_COUNT <= 0) {
                        ...
                        root.animHide(TIME_ANIM) {
                            game.navigationManager.navigate(Factory_6_Screen::class.java.name)
                        }
