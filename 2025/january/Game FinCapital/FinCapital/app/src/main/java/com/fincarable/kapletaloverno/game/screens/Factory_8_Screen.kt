...
class Factory_8_Screen(override val game: LibGDXGame) : AdvancedScreen() {

    private var TAP_COUNT  = 9
    ...
    private val imgFactory = Image(game.all.listT_8[Factory_4_Screen.BODY_INDEX][Factory_1_Screen.INTERIOR_INDEX])
    ...
    override fun AdvancedStage.addActorsOnStageUI() {
        ...
        imgFactory.setBounds(29f,515f,819f,478f)
                ...
                runGDX {
                    if (TAP_COUNT <= 0) {
                        ...
                        root.animHide(TIME_ANIM) {
                            game.navigationManager.navigate(SellScreen::class.java.name)
                        }
