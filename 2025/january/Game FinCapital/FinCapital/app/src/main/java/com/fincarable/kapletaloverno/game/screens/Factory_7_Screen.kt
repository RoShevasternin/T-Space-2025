...
class Factory_7_Screen(override val game: LibGDXGame) : AdvancedScreen() {

    private var TAP_COUNT  = 8
    ...
    private val imgFactory = Image(game.all.t7)
    ...
    override fun AdvancedStage.addActorsOnStageUI() {
        ...
        imgFactory.setBounds(29f,515f,819f,371f)
                ...
                runGDX {
                    if (TAP_COUNT <= 0) {
                        ...
                        root.animHide(TIME_ANIM) {
                            game.navigationManager.navigate(Factory_8_Screen::class.java.name)
                        }
