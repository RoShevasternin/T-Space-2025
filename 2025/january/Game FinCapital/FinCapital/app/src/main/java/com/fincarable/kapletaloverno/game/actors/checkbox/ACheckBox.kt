package com.fincarable.kapletaloverno.game.actors.checkbox
...
import com.fincarable.kapletaloverno.game.utils.TextureEmpty
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.DEFAULT -> Static.ACheckBoxStyle(
            ...
            checked = screen.game.all.selector,
        )
    }
