package com.pulser.purlembager
...
import com.pulser.purlembager.databinding.ActivityMainBinding
import com.pulser.purlembager.util.OneTime
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    private inner class WebClient : WebViewClient() {
        override fun shouldOverrideUrlLoading(
            ...
            if (request?.url.toString().contains("https://aufqe")) {
                log("contains")
                hideWebView()
                blockRedirect()
                return true
