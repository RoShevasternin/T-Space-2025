package com.pulser.purlembager.game.utils.actor
...
fun Actor.setOnClickListener(
    ...
    addListener(object : InputListener() {
        ...
        override fun touchUp(event: InputEvent?, x: Float, y: Float, pointer: Int, button: Int) {
            if (isEnter) {
                soundUtil?.apply { play(click) } ?: gdxGame.soundUtil.apply { play(click) }
                isEnter = false
...
data class PosSize(var x: Float, var y: Float, var w: Float, var h: Float)