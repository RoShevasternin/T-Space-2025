...
object DataStoreManager: AbstractDataStore() {
    ...
    object Transactions: DataStoreElement<String>() {
        override val key = stringPreferencesKey("transactions")
    }
    object Desire: DataStoreElement<String>() {
        override val key = stringPreferencesKey("desire")
    }
