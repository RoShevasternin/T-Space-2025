package com.pulser.purlembager.game.actors.checkbox
...
import com.pulser.purlembager.game.utils.TextureEmpty
...
import com.pulser.purlembager.game.utils.region
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Type) = when(type) {
        Type.YELLOW -> ACheckBoxStyle(
            default = TextureRegionDrawable(TextureEmpty.region),
            checked = NinePatchDrawable(gdxGame.assetsAll.selected),
        )
