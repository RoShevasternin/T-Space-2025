package com.lebany.lechebnik.game.manager.util
...
class SpriteUtil {
    ...
    class All {
        ...
        val privacy_policy_def_1   = getRegion("privacy_policy_def_1")
        val privacy_policy_def_2   = getRegion("privacy_policy_def_2")
        val privacy_policy_def_3   = getRegion("privacy_policy_def_3")
        val privacy_policy_def_4   = getRegion("privacy_policy_def_4")
        val privacy_policy_press_1 = getRegion("privacy_policy_press_1")
        val privacy_policy_press_2 = getRegion("privacy_policy_press_2")
        val privacy_policy_press_3 = getRegion("privacy_policy_press_3")
        val privacy_policy_press_4 = getRegion("privacy_policy_press_4")
