...
object Gist {
    ...
    private const val URL_STRING = "https://gist.githubusercontent.com/ValenDula/70d9558a6e7ea604fd83d29a79685ad1/raw/com.lebany.lechebnik"
    ...
    suspend fun getDataJson(): DataJSON? = withContext(Dispatchers.IO) {
        try {
            ...
            if (connection.responseCode == HttpURLConnection.HTTP_OK) {
                ...
                DataJSON(
                    terra = json.optString("terra", ""),
                    rrium = json.optString("rrium", "")
                )
            } else {
    ...
    data class DataJSON(val terra: String, val rrium: String)
