...
import com.vectorvesta.bronfinteh.game.actors.main.delete.AMainDeleteMortgage
...
class AItemMortgage(
    ...
    private val listHistoryItem = List(4) {
        AItemSimple(screen,
    ...
    override fun addActorsOnGroup() {
        addActor(lblTitle)
        lblTitle.setBounds(297f, 881f, 211f, 44f)
        lblTitle.setAlignment(Align.center)

        addActor(verticalGroup)
        verticalGroup.also {
            it.setBounds(0f, 0f, 805f, 803f)
        ...
        this.setOnTouchListener(gdxGame.soundUtil) {
            AMainDeleteMortgage.dataItems = this.dataItems

            screen.hideScreen {
                gdxGame.navigationManager.navigate(DeleteMortgageScreen::class.java.name)
            }
        }
    }
