...
class AMainDeleteDeposit(
    override val screen: DeleteDepositScreen,
): AdvancedMainGroup() {
    ...
    private fun addAScroll() {
        ...
        verticalGroup.setBounds(48f, 1065f, 805f, 379f)
    ...
    private fun addBtns() {
        ...
        btnCalculate.setOnClickListener {
            gdxGame.navigationManager.navigate(CalculatorDepositScreen::class.java.name)
        }
