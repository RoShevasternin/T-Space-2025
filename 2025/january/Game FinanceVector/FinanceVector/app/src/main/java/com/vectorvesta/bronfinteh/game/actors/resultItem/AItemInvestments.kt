...
import com.vectorvesta.bronfinteh.game.actors.main.delete.AMainDeleteInvestments
...
class AItemInvestments(
    ...
    override fun addActorsOnGroup() {
        ...
        this.setOnTouchListener(gdxGame.soundUtil) {
            AMainDeleteInvestments.dataItems = this.dataItems

            screen.hideScreen {
                gdxGame.navigationManager.navigate(DeleteInvestmentsScreen::class.java.name)
            }
        }
    }
