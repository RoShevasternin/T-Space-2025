...
class AMainDeleteLeasing(
    override val screen: DeleteLeasingScreen,
): AdvancedMainGroup() {
    ...
    private val listItemSimple = List(5) {
        AItemSimple(screen,
    ...
    private fun addAScroll() {
        ...
        verticalGroup.setBounds(48f, 428f, 805f, 1015f)
    ...
    private fun addBtns() {
        ...
        btnCalculate.setBounds(48f, 86f, 805f, 135f)

        btnCalculate.setOnClickListener {
            gdxGame.navigationManager.navigate(CalculatorLeasingScreen::class.java.name)
        }

        addActor(btnRemove)
        btnRemove.setBounds(48f, 257f, 805f, 135f)
