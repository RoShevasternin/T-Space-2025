...
import com.vectorvesta.bronfinteh.game.actors.resultItem.GLOBAL_listTitleLoan
...
class AMainDeleteLoan(
    override val screen: DeleteLoanScreen,
): AdvancedMainGroup() {
    ...
    private fun addAScroll() {
        ...
        verticalGroup.setBounds(48f, 640f, 805f, 804f)
    ...
    private fun addBtns() {
        ...
        btnCalculate.setOnClickListener {
            gdxGame.navigationManager.navigate(CalculatorLoanScreen::class.java.name)
        }
