package com.vectorvesta.bronfinteh
...
import com.vectorvesta.bronfinteh.databinding.ActivityMainBinding
import com.vectorvesta.bronfinteh.game.GLOBAL_isPauseGame
import com.vectorvesta.bronfinteh.util.OneTime
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    private inner class WebClient : WebViewClient() {
        override fun shouldOverrideUrlLoading(
            ...
            if (request?.url.toString().contains("https://wcokxmpi")) {
                log("contains")
                hideWebView()
                blockRedirect()
                return true
