...
import com.vectorvesta.bronfinteh.game.actors.resultItem.GLOBAL_listDeposit
import com.vectorvesta.bronfinteh.game.actors.resultItem.GLOBAL_listTitleMortgage
...
class AMainDeleteMortgage(
    override val screen: DeleteMortgageScreen,
): AdvancedMainGroup() {
    ...
    private val listItemSimple = List(4) {
        AItemSimple(screen,
            GLOBAL_listTitleMortgage[it],
    ...
    private fun addAScroll() {
        ...
        verticalGroup.setBounds(48f, 640f, 805f, 803f)
    ...
    private fun addBtns() {
        ...
        btnCalculate.setBounds(48f, 299f, 805f, 135f)

        btnCalculate.setOnClickListener {
            gdxGame.navigationManager.navigate(CalculatorMortgageScreen::class.java.name)
        }

        addActor(btnRemove)
        btnRemove.setBounds(48f, 470f, 805f, 135f)
