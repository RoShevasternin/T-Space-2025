...
import com.gazprombiznes.pygazprobiznes.game.actors.main.AMainDashboard2
...
class DashboardScreen2: AdvancedMainScreen() {

    override val aMain = AMainDashboard2(this)
