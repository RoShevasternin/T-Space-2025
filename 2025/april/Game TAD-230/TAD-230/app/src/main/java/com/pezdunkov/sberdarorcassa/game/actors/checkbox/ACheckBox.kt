package com.pezdunkov.sberdarorcassa.game.actors.checkbox
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Type) = when(type) {
        Type.S1 -> ACheckBoxStyle(
            default = gdxGame.assetsAll.s1_def,
            checked = gdxGame.assetsAll.s1_press,
        )
        Type.S2 -> ACheckBoxStyle(
            default = gdxGame.assetsAll.s2_def,
            checked = gdxGame.assetsAll.s2_press,
        )
        Type.S3 -> ACheckBoxStyle(
            default = gdxGame.assetsAll.s3_def,
            checked = gdxGame.assetsAll.s3_press,
        )
        Type.S4 -> ACheckBoxStyle(
            default = gdxGame.assetsAll.s4_def,
            checked = gdxGame.assetsAll.s4_press,
        )
    }
