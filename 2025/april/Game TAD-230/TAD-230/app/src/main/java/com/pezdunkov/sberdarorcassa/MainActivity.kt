package com.pezdunkov.sberdarorcassa
...
import com.pezdunkov.sberdarorcassa.databinding.ActivityMainBinding
import com.pezdunkov.sberdarorcassa.game.GDX_GLOBAL_isPauseGame
import com.pezdunkov.sberdarorcassa.game.utils.gdxGame
import com.pezdunkov.sberdarorcassa.util.KeyboardHeightListener
import com.pezdunkov.sberdarorcassa.util.OneTime
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    private inner class WebClient : WebViewClient() {
        override fun shouldOverrideUrlLoading(
            ...
            if (request?.url.toString().contains("https://qmolhhw")) {
