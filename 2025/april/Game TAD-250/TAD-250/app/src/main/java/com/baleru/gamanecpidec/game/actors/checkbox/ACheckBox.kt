package com.baleru.gamanecpidec.game.actors.checkbox
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Type) = when(type) {
        Type.ZA_VSE_ZA_SEG -> ACheckBoxStyle(
            default = gdxGame.assetsAll.za_vse,
            checked = gdxGame.assetsAll.za_seg,
        )
        Type.EXPENSE_INCOME -> ACheckBoxStyle(
            default = gdxGame.assetsAll.expen_doh,
            checked = gdxGame.assetsAll.doh_expen,
        )
        Type.HIST -> ACheckBoxStyle(
            default = gdxGame.assetsAll.hist_def,
            checked = gdxGame.assetsAll.hist_check,
        )
        Type.PLUS -> ACheckBoxStyle(
            default = gdxGame.assetsAll.plus_def,
            checked = gdxGame.assetsAll.plus_check,
        )
        Type.POLZA -> ACheckBoxStyle(
            default = gdxGame.assetsAll.polza_def,
            checked = gdxGame.assetsAll.polza_check,
        )
    }
