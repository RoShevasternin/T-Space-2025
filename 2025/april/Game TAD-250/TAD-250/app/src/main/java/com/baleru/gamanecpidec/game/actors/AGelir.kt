...
class AGelir(override val screen: AdvancedScreen): AdvancedGroup() {
    ...
    private val listItem = List(3) { ACategoryItem(screen, cbg, gdxGame.assetsAll.listINCOME[it], GLOBAL_listCategoryName_Income[it], ls26) }
