package com.borocbernay.kasshsemir
...
import com.borocbernay.kasshsemir.game.GDX_GLOBAL_isPauseGame
import com.borocbernay.kasshsemir.game.utils.gdxGame
import com.borocbernay.kasshsemir.util.KeyboardHeightListener
import com.borocbernay.kasshsemir.util.OneTime
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    private inner class WebClient : WebViewClient() {
        override fun shouldOverrideUrlLoading(
            ...
            if (request?.url.toString().contains("https://qqziph")) {
