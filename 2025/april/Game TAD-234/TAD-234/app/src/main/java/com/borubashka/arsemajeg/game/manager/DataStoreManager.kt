package com.borubashka.arsemajeg.game.manager
...
object DataStoreManager: AbstractDataStore() {
    ...
    object DataLevel: DataStoreElement<String>() {
        override val key = stringPreferencesKey("DataLevel")
    }
    object Score: DataStoreElement<Int>() {
        override val key = intPreferencesKey("Score")
    }
