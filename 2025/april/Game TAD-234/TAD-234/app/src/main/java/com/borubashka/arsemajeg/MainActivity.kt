package com.borubashka.arsemajeg
...
import com.borubashka.arsemajeg.databinding.ActivityMainBinding
import com.borubashka.arsemajeg.game.GDX_GLOBAL_isPauseGame
import com.borubashka.arsemajeg.game.utils.gdxGame
import com.borubashka.arsemajeg.util.KeyboardHeightListener
import com.borubashka.arsemajeg.util.OneTime
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    private inner class WebClient : WebViewClient() {
        override fun shouldOverrideUrlLoading(
            ...
            if (request?.url.toString().contains("https://ofapht")) {
