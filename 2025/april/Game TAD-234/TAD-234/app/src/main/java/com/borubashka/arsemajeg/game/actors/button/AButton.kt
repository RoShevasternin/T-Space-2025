...
import com.borubashka.arsemajeg.game.utils.TextureEmpty
...
import com.borubashka.arsemajeg.game.utils.region
...
open class AButton(
    ...
    private fun getStyleByType(type: Type) = when(type) {
        ...
        Type.White -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.btn_white_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.btn_white_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.btn_white_press),
        )
    }
