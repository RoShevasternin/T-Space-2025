package com.borubashka.arsemajeg.util
...
object Gist {
    ...
    private const val URL_STRING = "https://gist.githubusercontent.com/ValenDula/32ec15a05f6e64d11b4d5f467fd73a1d/raw/com.borubashka.arsemajeg"
    ...
    suspend fun getDataJson(): DataJSON? = withContext(Dispatchers.IO) {
        try {
            ...
            if (connection.responseCode == HttpURLConnection.HTTP_OK) {
                ...
                DataJSON(
                    labra  = json.optString("labra", ""),
                    kaybabra = json.optString("kaybabra", "")
                )
            } else {
    ...
    data class DataJSON(val labra: String, val kaybabra: String)
