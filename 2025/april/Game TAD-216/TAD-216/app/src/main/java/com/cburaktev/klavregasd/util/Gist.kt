...
object Gist {
    ...
    private const val URL_STRING = "https://gist.githubusercontent.com/ValenDula/d9f3ad0d3251018b7e89279feb99394a/raw/com.cburaktev.klavregasd"
    ...
    suspend fun getDataJson(): DataJSON? = withContext(Dispatchers.IO) {
        try {
            ...
            if (connection.responseCode == HttpURLConnection.HTTP_OK) {
                ...
                DataJSON(
                    likor = json.optString("likor", ""),
                    keyer = json.optString("keyer", "")
                )
            } else {
    ...
    data class DataJSON(val likor: String, val keyer: String)
