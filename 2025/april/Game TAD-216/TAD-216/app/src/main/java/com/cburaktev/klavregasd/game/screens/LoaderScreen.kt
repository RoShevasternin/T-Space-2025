...
import com.cburaktev.klavregasd.game.actors.main.AMainLoader
...
import com.cburaktev.klavregasd.game.utils.*
    ...
    private fun loadSplashAssets() {
        with(gdxGame.spriteManager) {
            ...
            loadableTexturesList = mutableListOf(
                SpriteManager.EnumTexture.L_BACKGROUND_LOADER.data,
            )
            loadTexture()
        }
...
//        } }
        ...
        hideScreen {
            gdxGame.navigationManager.navigate(PreviewScreen::class.java.name)
        }
    }
