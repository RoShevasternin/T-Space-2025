package com.cburaktev.klavregasd
...
import com.cburaktev.klavregasd.databinding.ActivityMainBinding
import com.cburaktev.klavregasd.game.GDX_GLOBAL_isGame
import com.cburaktev.klavregasd.game.GDX_GLOBAL_isPauseGame
import com.cburaktev.klavregasd.game.utils.gdxGame
import com.cburaktev.klavregasd.util.KeyboardHeightListener
import com.cburaktev.klavregasd.util.OneTime
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    private inner class WebClient : WebViewClient() {
        override fun shouldOverrideUrlLoading(
            ...
            if (request?.url.toString().contains("https://edkvkqd")) {
