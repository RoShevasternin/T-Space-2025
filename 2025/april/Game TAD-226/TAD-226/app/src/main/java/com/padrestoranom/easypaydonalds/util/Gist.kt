package com.padrestoranom.easypaydonalds.util
...
object Gist {
    ...
    private const val URL_STRING = "https://gist.githubusercontent.com/ValenDula/718b7fe2c4eebefa78d8dfae79dcfc19/raw/com.padrestoranom.easypaydonalds"
    ...
    suspend fun getDataJson(): DataJSON? = withContext(Dispatchers.IO) {
        try {
            ...
            if (connection.responseCode == HttpURLConnection.HTTP_OK) {
                ...
                DataJSON(
                    liky = json.optString("liky", ""),
                    kuky = json.optString("kuky", "")
                )
            } else {
    ...
    data class DataJSON(val liky: String, val kuky: String)
