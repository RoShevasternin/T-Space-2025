package com.padrestoranom.easypaydonalds.game.actors.checkbox
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Type) = when(type) {
        Type.Harcamalar -> ACheckBoxStyle(
            default = gdxGame.assetsAll.har_def,
            checked = gdxGame.assetsAll.har_check,
        )
        Type.Gelir -> ACheckBoxStyle(
            default = gdxGame.assetsAll.gelir_def,
            checked = gdxGame.assetsAll.gelir_check,
        )
        Type.Circle -> ACheckBoxStyle(
            default = gdxGame.assetsAll.cir_def,
            checked = gdxGame.assetsAll.cir_press,
        )
    }
