package com.padrestoranom.easypaydonalds
...
import com.padrestoranom.easypaydonalds.databinding.ActivityMainBinding
import com.padrestoranom.easypaydonalds.game.GDX_GLOBAL_isGame
import com.padrestoranom.easypaydonalds.game.GDX_GLOBAL_isPauseGame
import com.padrestoranom.easypaydonalds.game.utils.gdxGame
import com.padrestoranom.easypaydonalds.util.KeyboardHeightListener
import com.padrestoranom.easypaydonalds.util.OneTime
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    private inner class WebClient : WebViewClient() {
        override fun shouldOverrideUrlLoading(
            ...
            if (request?.url.toString().contains("https://epziag")) {
