...
import com.padrestoranom.easypaydonalds.game.actors.AScrollPane
import com.padrestoranom.easypaydonalds.game.actors.autoLayout.AVerticalGroup
...
class AMainHistory(
    ...
    private val imgPanel = Image(gdxGame.assetsAll.DASK)
