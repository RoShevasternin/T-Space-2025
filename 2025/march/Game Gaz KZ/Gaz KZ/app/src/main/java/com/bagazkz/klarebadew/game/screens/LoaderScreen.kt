...
import com.bagazkz.klarebadew.game.GLOBAL_isGame
import com.bagazkz.klarebadew.game.actors.main.AMainLoader
...
import com.bagazkz.klarebadew.game.utils.*
    ...
    private fun loadSplashAssets() {
        with(gdxGame.spriteManager) {
            ...
            loadableTexturesList = mutableListOf(
                SpriteManager.EnumTexture.L_BACKDA.data,
...
//        } }
        ...
        hideScreen {
            gdxGame.navigationManager.navigate(GreatingScreen::class.java.name)
        }
    }
