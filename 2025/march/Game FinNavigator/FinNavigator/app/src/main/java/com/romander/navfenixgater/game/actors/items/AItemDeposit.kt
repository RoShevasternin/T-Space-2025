...
class AItemDeposit(
    ...
    private val valueList = listOf(
        data.totalBody.toSeparateWithSymbol(' ') + " ₽",
        data.totalInterest.toSeparateWithSymbol(' ') + " ₽",
    )
    ...
    private val listLblField = List(2) { Label(fieldList[it], ls30) }
    private val listLblValue = List(2) { Label(valueList[it], ls36_Yellow) }
    ...
    private fun addValues() {
        ...
        lblItemTitle.setBounds(0f, 169f, 220f, 67f)
