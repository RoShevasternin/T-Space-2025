...
class AItemIpoteka(
    ...
    private val valueList = listOf(
        data.totalPayment.toSeparateWithSymbol(' ') + " ₽",
        data.interestPaid .toSeparateWithSymbol(' ') + " ₽",
        data.loanBody.toSeparateWithSymbol(' ') + " ₽",
        data.commissions.toSeparateWithSymbol(' ') + " %",
    )
