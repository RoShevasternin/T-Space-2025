...
class ACalculatorInvest(override val screen: AdvancedScreen): ACalculatorAnimator(screen) {
    ...
    private fun AdvancedGroup.addMainTmpGroup() {
        ...
        mainATmpGroup.setBounds(0f, this.height - this@ACalculatorInvest.height, this@ACalculatorInvest.width, this@ACalculatorInvest.height)
    }
