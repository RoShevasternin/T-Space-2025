...
import com.romander.navfenixgater.game.actors.main.AMainHistory
import com.romander.navfenixgater.game.actors.main.AMainMenu
import com.romander.navfenixgater.game.utils.Block
import com.romander.navfenixgater.game.utils.HEIGHT_UI
...
class HistoryScreen: AdvancedMainScreen() {
    ...
    private val aBottom = ABottom(this, ABottom.DefType.Hist)

    override val aMain = AMainHistory(this, aBottom)
