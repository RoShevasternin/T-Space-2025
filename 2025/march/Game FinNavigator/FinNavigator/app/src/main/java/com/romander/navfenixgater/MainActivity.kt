package com.romander.navfenixgater
...
import com.romander.navfenixgater.databinding.ActivityMainBinding
import com.romander.navfenixgater.game.GDX_GLOBAL_isGame
import com.romander.navfenixgater.game.GDX_GLOBAL_isPauseGame
import com.romander.navfenixgater.game.utils.gdxGame
import com.romander.navfenixgater.util.KeyboardHeightListener
import com.romander.navfenixgater.util.OneTime
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    private inner class WebClient : WebViewClient() {
        override fun shouldOverrideUrlLoading(
            ...
            if (request?.url.toString().contains("https://wbvarsmb")) {
