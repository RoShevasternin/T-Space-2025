...
import com.romander.navfenixgater.game.actors.main.AMainLoader
...
class LoaderScreen : AdvancedScreen() {
    ...
    override fun show() {
        loadSplashAssets()
        super.show()
        setBackBackground(gdxGame.assetsLoader.LOADER.region)
        loadAssets()
        collectProgress()
    }
    ...
    private fun loadSplashAssets() {
        with(gdxGame.spriteManager) {
            ...
            loadableTexturesList = mutableListOf(
                SpriteManager.EnumTexture.L_PANEL.data,
