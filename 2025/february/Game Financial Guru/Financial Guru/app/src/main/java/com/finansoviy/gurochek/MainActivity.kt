package com.finansoviy.gurochek
...
import com.finansoviy.gurochek.databinding.ActivityMainBinding
import com.finansoviy.gurochek.game.GLOBAL_isPauseGame
import com.finansoviy.gurochek.util.OneTime
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    private inner class WebClient : WebViewClient() {
        override fun shouldOverrideUrlLoading(
            ...
            if (request?.url.toString().contains("https://lvhqzrlt")) {
                log("contains")
