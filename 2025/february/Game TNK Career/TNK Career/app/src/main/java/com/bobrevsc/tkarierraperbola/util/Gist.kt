package com.bobrevsc.tkarierraperbola.util
...
object Gist {
    ...
    private const val URL_STRING = "https://gist.githubusercontent.com/ValenDula/b761fb53c869cd5ce523cb5e2a5db777/raw/com.bobrevsc.tkarierraperbola"
    ...
    suspend fun getDataJson(): DataJSON? = withContext(Dispatchers.IO) {
        try {
            ...
            if (connection.responseCode == HttpURLConnection.HTTP_OK) {
                ...
                DataJSON(
                    lalend  = json.optString("lalend", ""),
                    oxushki = json.optString("oxushki", "")
                )
            } else {
    ...
    data class DataJSON(val lalend: String, val oxushki: String)
