package com.sberigatelny.finexpertaizer.game.actors.button
...
import com.sberigatelny.finexpertaizer.game.utils.TextureEmpty
...
open class AButton(
    ...
    private fun getStyleByType(type: Type) = when(type) {
        ...
        Type.ToWork -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.to_work),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.to_work_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.to_work_press),
        )
        Type.Pereezd -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.pereezd),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.pereezd_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.pereezd_press),
        )
