...
import com.sberigatelny.finexpertaizer.game.GLOBAL_isGame
import com.sberigatelny.finexpertaizer.game.actors.main.AMainLoader
        ...
        coroutine?.launch {
            ...
            progressFlow.collect { p ->
                while (progress < (p * 100)) {
                    progress += 1
                    runGDX { aMain.updatePercent(progress.toFloat()) }
...
//        } }
        ...
        hideScreen {
            gdxGame.navigationManager.navigate(
                if (gdxGame.ds_IsTutorial.flow.value) StartScreen::class.java.name else GameScreen::class.java.name
            )
        }
    }
