...
import com.ekobioznaher.sugertogerra.game.actors.main.balance
import com.ekobioznaher.sugertogerra.game.actors.main.range
...
class APanel(override val screen: AdvancedScreen): AdvancedGroup() {
    ...
    private val ls58 = Label.LabelStyle(font58, GameColor.text.cpy().apply { a = 0.90f })
    private val ls46 = Label.LabelStyle(font46, GameColor.text.cpy().apply { a = 0.68f })
