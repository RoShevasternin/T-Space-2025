...
import com.ekobioznaher.sugertogerra.game.GDXGame
...
import com.ekobioznaher.sugertogerra.game.utils.actor.setBounds
import com.ekobioznaher.sugertogerra.game.utils.actor.setOnClickListener
...
class AMainQuestion(
    ...
    private val ls61 = Label.LabelStyle(font61, GameColor.text)
    private val ls49 = Label.LabelStyle(font49, GameColor.text)
    private val ls37 = Label.LabelStyle(font_37, GameColor.text)
    ...
    private val lblVopros   = TypingLabel(textUsed, fontLightExtraBold, GameColor.text)
