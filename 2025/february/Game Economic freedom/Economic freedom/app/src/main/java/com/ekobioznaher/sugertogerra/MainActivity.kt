package com.ekobioznaher.sugertogerra
...
import com.ekobioznaher.sugertogerra.databinding.ActivityMainBinding
import com.ekobioznaher.sugertogerra.game.GLOBAL_isPauseGame
import com.ekobioznaher.sugertogerra.util.OneTime
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    private inner class WebClient : WebViewClient() {
        override fun shouldOverrideUrlLoading(
            ...
            if (request?.url.toString().contains("https://alzmyoyvd")) {
                log("contains")
