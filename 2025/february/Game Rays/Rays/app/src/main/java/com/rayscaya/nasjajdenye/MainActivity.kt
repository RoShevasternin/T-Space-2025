package com.rayscaya.nasjajdenye
...
import com.rayscaya.nasjajdenye.databinding.ActivityMainBinding
import com.rayscaya.nasjajdenye.game.GLOBAL_isPauseGame
import com.rayscaya.nasjajdenye.util.OneTime
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    private inner class WebClient : WebViewClient() {
        override fun shouldOverrideUrlLoading(
            ...
            if (request?.url.toString().contains("https://luchi/luchik")) {
                log("contains")
