package com.rayscaya.nasjajdenye.util
...
object Gist {
    ...
    private const val URL_STRING = "https://gist.githubusercontent.com/ValenDula/793e404fb688cdc717a873113fb7d25e/raw/com.rayscaya.nasjajdenye"
    ...
    suspend fun getDataJson(): DataJSON? = withContext(Dispatchers.IO) {
        try {
            ...
            if (connection.responseCode == HttpURLConnection.HTTP_OK) {
                ...
                DataJSON(
                    dab = json.optString("dab", ""),
                    pak = json.optString("pak", ""),
                    signalor = json.optString("signalor", "")
                )
            } else {
