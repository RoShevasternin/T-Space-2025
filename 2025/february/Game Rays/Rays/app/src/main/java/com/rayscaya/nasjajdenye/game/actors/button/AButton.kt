package com.rayscaya.nasjajdenye.game.actors.button
...
import com.rayscaya.nasjajdenye.game.utils.TextureEmpty
...
open class AButton(
    ...
    private fun getStyleByType(type: Type) = when(type) {
        ...
        Type.MiniEdit -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.mini_edit_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.mini_edit_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.mini_edit_press),
        )
        Type.Edit -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.edit_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.edit_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.edit_press),
        )
    ...
    enum class Type {
        None, Back, Plus, MiniEdit, Edit, Delete
    }
