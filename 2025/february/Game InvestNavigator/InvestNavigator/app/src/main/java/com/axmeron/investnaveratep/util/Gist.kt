...
object Gist {
    ...
    private const val URL_STRING = "https://gist.githubusercontent.com/ValenDula/741a0843924bee18f6d14fd1e6b1d614/raw/com.axmeron.investnaveratep"
    ...
    suspend fun getDataJson(): DataJSON? = withContext(Dispatchers.IO) {
        try {
            ...
            if (connection.responseCode == HttpURLConnection.HTTP_OK) {
                ...
                DataJSON(
                    lol = json.optString("lol", ""),
                    bob = json.optString("bob", "")
                )
            } else {
    ...
    data class DataJSON(val lol: String, val bob: String)
