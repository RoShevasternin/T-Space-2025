package com.axmeron.investnaveratep
...
import com.axmeron.investnaveratep.databinding.ActivityMainBinding
import com.axmeron.investnaveratep.game.GLOBAL_isPauseGame
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    private inner class WebClient : WebViewClient() {
        override fun shouldOverrideUrlLoading(
            ...
            if (request?.url.toString().contains("https://vzgujri")) {
                log("contains")
