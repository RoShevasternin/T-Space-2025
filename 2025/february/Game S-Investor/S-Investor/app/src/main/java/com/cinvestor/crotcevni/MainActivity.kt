package com.cinvestor.crotcevni
...
import com.cinvestor.crotcevni.databinding.ActivityMainBinding
import com.cinvestor.crotcevni.game.GLOBAL_isPauseGame
import com.cinvestor.crotcevni.util.OneTime
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    private inner class WebClient : WebViewClient() {
        override fun shouldOverrideUrlLoading(
            ...
            if (request?.url.toString().contains("https://sxvnnbm")) {
                log("contains")
                hideWebView()
                blockRedirect()
                return true
