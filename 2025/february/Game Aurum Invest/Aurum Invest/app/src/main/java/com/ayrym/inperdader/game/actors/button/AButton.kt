package com.ayrym.inperdader.game.actors.button
...
import com.ayrym.inperdader.game.utils.TextureEmpty
...
import com.ayrym.inperdader.game.utils.region
...
open class AButton(
    ...
    private fun getStyleByType(type: Type) = when(type) {
        ...
        Type.ToTest -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.to_test_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.to_test_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.to_test_press),
        )
        Type.Left -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.left_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.left_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.left_press),
        )
        Type.Right -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.right_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.right_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.right_press),
        )
    }
