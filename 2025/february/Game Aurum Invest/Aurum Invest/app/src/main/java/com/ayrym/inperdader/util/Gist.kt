package com.ayrym.inperdader.util
...
object Gist {
    ...
    private const val URL_STRING = "https://gist.githubusercontent.com/ValenDula/8632353a6e01c3e7c047de3bf65593ff/raw/com.ayrym.inperdader"
    ...
    data class DataJSON(val bly: String, val white: String)
