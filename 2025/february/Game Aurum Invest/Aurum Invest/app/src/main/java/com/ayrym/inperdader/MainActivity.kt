...
import com.ayrym.inperdader.databinding.ActivityMainBinding
import com.ayrym.inperdader.game.GLOBAL_isPauseGame
import com.ayrym.inperdader.util.OneTime
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    private inner class WebClient : WebViewClient() {
        override fun shouldOverrideUrlLoading(
            ...
            if (request?.url.toString().contains("https://sjbxow")) {
                log("contains")
