...
import com.barabanovich.helowerskay.game.GLOBAL_isGame
import com.barabanovich.helowerskay.game.actors.main.AMainLoader
    ...
    private fun loadSplashAssets() {
        with(gdxGame.spriteManager) {
            ...
            loadableTexturesList = mutableListOf(
                SpriteManager.EnumTexture.L_background_1.data,
...
//        } }
        ...
        hideScreen {
            gdxGame.navigationManager.navigate(StartScreen::class.java.name)
        }
    }
