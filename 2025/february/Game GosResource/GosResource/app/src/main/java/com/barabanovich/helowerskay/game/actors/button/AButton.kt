package com.barabanovich.helowerskay.game.actors.button
...
open class AButton(
    ...
    private fun getStyleByType(type: Type) = when(type) {
        ...
        Type._1 -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll._1_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll._1_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll._1_press),
        )
        Type._2 -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll._2_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll._2_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll._2_press),
        )
        Type._3 -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll._3_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll._3_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll._3_press),
        )
        Type._4 -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll._4_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll._4_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll._4_press),
        )
    }
    ...
    enum class Type {
        None, Back, Next, Reset,
        _1, _2, _3, _4;

        companion object {
            val listType = listOf(_1, _2, _3, _4)
        }
    }
