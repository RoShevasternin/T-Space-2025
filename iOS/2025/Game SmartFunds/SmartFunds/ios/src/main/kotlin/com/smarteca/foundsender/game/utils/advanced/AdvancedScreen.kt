...
import com.smarteca.foundsender.game.utils.font.FontGenerator
import com.smarteca.foundsender.game.utils.font.FontGenerator.Companion.FontPath
...
abstract class AdvancedScreen(
    ...
    override fun resize(width: Int, height: Int) {
        sizeScalerScreen.calculateScale(width.toFloat(), height.toFloat() + gdxGame.statusBarHeight)

        viewportBack.update(width, height + gdxGame.statusBarHeight, true)
