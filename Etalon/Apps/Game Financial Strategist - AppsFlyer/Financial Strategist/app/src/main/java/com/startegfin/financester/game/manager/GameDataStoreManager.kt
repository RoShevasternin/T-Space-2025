...
object GameDataStoreManager: AbstractDataStore() {
    ...
    object RoshodList: AbstractDataStore.DataStoreElement<String>() {
        override val key = stringPreferencesKey("roshodList")
    }
    object DohodList: AbstractDataStore.DataStoreElement<String>() {
        override val key = stringPreferencesKey("dohodList")
    }
